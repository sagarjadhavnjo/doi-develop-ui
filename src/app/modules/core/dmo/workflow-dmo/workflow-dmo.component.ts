...
import { HeaderElement } from '../../common/model/common-listing';
import { ReplaySubject, Subject, Observable } from 'rxjs';
import { ToastrService } from 'ngx-toastr';
import { Router } from '@angular/router';
import { BehaviorSubject } from 'rxjs';
import { NssfLoanService } from '../services/nssf-loan.service';
import { setDPRequestObject } from '../model/nssf-loan.data-model'
...
@Component({
  selector: 'app-workflow-dmo',
  templateUrl: './workflow-dmo.component.html',
  styleUrls: ['./workflow-dmo.component.css']
})
export class WorkflowDmoComponent implements OnInit {
  ...
  constructor(private elem: ElementRef,
    ...
    public dialogRef: MatDialogRef<WorkflowDmoComponent>,
  ...
  ngOnInit() {
    ...
    if (this.data === 'nssfLoan') {
      this.screenName = 'NSSF Loan Received';
      this.headerJso = [
        { label: 'Financial Year', value: '2020-2021' },
    ...
    } else if (this.data === 'dpSheet') {
      this.screenName = 'Daily Position Sheet';
      this.headerJso = [
        { label: 'Financial Year', value: '2020-2021' },
        { label: 'Name of Office', value: 'Finance Department, Gandhinagar' },
        { label: 'Code', value: '104' },
        { label: 'DP Sheet Date', value: '07-Jan-2021' },
        { label: 'Memo No.', value: '22' },];
    } else {
      this.screenName = 'NSSF Loan Received';
      this.headerJso = [
        { label: 'Financial Year', value: '2020-2021' },
  ...
  onSubmit(): void {
    ...
    if(this.data && this.data.id) {
      reqObj = setDPRequestObject(this.data);
      reqObj['id']=this.data.id;
    } else {
      reqObj = setDPRequestObject(this.data);
    }
    this._nssfLoanService.saveNssfLoanDetails(reqObj).subscribe((res: any) => {
...
/* adviceBy: "TdaCssSZsb"
adviceDate: "2018-11-01"
adviceNo: "TMUyPeearw730"
creditAmount: 591.33
dpDate: ""
interestInstalmentsInYear: "11"
interestTotalNoOfInstalments: "11"
loanAmount: "123"
loanReceiptDate: Thu Jul 15 2021 00:00:00 GMT+0530 (India Standard Time) {}
loanTenure: "11"
memoNo: "bjwAegTsj30"
moratoriumPeriod: "12"
principalInstalmentsInYear: "11"
principalTotalNoOfInstalments: "11"
rateOfInterest: "13"
sanctionDate: Wed Jul 14 2021 00:00:00 GMT+0530 (India Standard Time) {}
sanctionNo: "12"
transactionDescription: "TnNzmZrTB" */
