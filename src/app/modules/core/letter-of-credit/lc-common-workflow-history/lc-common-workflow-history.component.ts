...
import { CommonWfMsg,previewExtension} from '../../common/constant/common-workflow.constants';
...
@Component({
  selector: 'app-lc-common-workflow-history',
  templateUrl: './lc-common-workflow-history.component.html',
  styleUrls: ['./lc-common-workflow-history.component.css']
})
export class LcCommonWorkflowHistoryComponent implements OnInit {
  ...
  constructor(
      ...
      public dialogRef: MatDialogRef<LcCommonWorkflowHistoryComponent>,
