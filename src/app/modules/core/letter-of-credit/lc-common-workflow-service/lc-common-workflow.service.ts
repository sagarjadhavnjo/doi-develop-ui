...
import { APIConst } from '../lc-common-workflow-constant/lc-common-workflow.constants';
...
export class LcCommonWorkflowService {
 ...
 * @param param: any - Request parameter that required to pass to api
 */
 getWorkFlowActionV3(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.WORKFLOW_ACTION_V3}`, param);
}
/**
 ...
 * @param param: any - Request parameter that required to pass to api
 */
 getWorkFlowUsersV3(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.WORKFLOW_USER_V3}`, param);
}
/**
 * @description to get the User list
 * @param param: any - Request parameter that required to pass to api
 */
 getWorkFlowGenRequestV3(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.WORKFLOW_GEN_REQUEST_V3}`, param);
}
 ...
 * @param param: any - Request parameter that required to pass to api
 */
 submitWorkFlowV3(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.WORKFLOW_SUBMIT_V3}`, param);
}
...
getCoOffice(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.GET_CO_OFFICE_BY_DEPARTMENT_ID}`, param);
}
 ...
 * @param param: any - Request parameter that required to pass to api
 */
getOfficeByOfficeTypeAndSubType(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.GET_OFFICE_BY_TYPE_AND_SUB_TYPE}`, param);
}

getToOffice(param) {
    return this.httpClient.post(`${environment.baseUrl}${APIConst.GET_TO_OFFICE_BY_DISTRICT_ID}`, param);
}
