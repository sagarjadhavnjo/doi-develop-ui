...
export class JpaRejectionListingComponent implements OnInit {
  ...
  constructor(private router: Router, private el: ElementRef, private datePipe: DatePipe,
  ...
  onPaginateChange(event) {
    ...
    let cnt = 0;
    opt[cnt++] = { 'key': 'claimStatus', 'value': APIConst.JPA_CLAIM_RETURN_TO_NODEL_APPLICATION };
