...
import { WorkflowDetailsLfComponent } from 'src/app/modules/core/doi/workflow-details-lf/workflow-details-lf.component';
import { BrwoseDatagrant } from 'src/app/models/common-grant';
import { CommonListing, HeaderElement } from 'src/app/models/common-listing';
...
@Component({
  selector: 'app-workflow-doi-module',
  templateUrl: './workflow-doi-module.component.html',
  styleUrls: ['./workflow-doi-module.component.css']
})
export class WorkflowDoiModuleComponent implements OnInit {
