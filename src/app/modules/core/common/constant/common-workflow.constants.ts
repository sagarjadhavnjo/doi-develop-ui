export const APIConst = {
    ...
    WORKFLOW_ACTION: 'common/wf/wfnextactions/201',
    WORKFLOW_USER: 'common/wf/user/action/config/201',
    ...
    GET_HOD: 'edp/msoffice/gethodbydeptoffid/301',
    GET_UNQ_HOD: 'budget/sc/getofficesce/201',
    GET_CO: 'edp/msoffice/getcobyhodoffid/301',
    GET_AD_OFFICE: 'edp/msoffice/alladoffices/301',
    GET_UNQ_AD_OFFICE: 'budget/sc/getalldept/201',
    GET_PARENT_OFFICE: 'edp/msoffice/getparent/301',
    WORKFLOW_SUBMIT: 'common/wf/trn/submit/101',
    ...
    GET_DAT_OFFICE_NAME_FOR_RECEIPT: 'receipt/departmentRegistration/officeForAlias/201',
    ...
    GET_GAD_OFFICE: 'budget/alias/officeForAlias/201'
};
...
export const DataConstant = {
    ...
    GAD_OFFICE_ALIAS: 'GAD_ALIAS',
    STANDING_CHARGE_ESTIMATE: 'STANDING_CHARGE_ESTIMATE',
    ASSIGN_TYPE: 'SINGLE_USER',
    DPPF: 'DPPF_OFFICE',
    PENSION: 'Pension'
};
