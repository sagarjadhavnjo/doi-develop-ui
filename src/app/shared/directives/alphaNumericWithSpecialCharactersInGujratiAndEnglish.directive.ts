...
@Directive({
    selector: '[appAlphaNumericWithSpecialCharatecersInGujaratiAndEnglish]'
})
export class AlphaNumericWithSpecialCharatecersInGujaratiAndEnglisDirective  {
    // tslint:disable-next-line: no-input-rename
    @Input() appAlphaNumericWithSpecialCharatecersInGujaratiAndEnglish: boolean = true;
    ...
    @HostListener('keyup', ['$event']) onKeyUp(event) {
        if (!this.appAlphaNumericWithSpecialCharatecersInGujaratiAndEnglish) {
            return;
        }
