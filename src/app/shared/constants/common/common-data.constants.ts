...
export const DataConst = {
    ...
    NOTIFICATION: {
        NO_NOTIFICATION_MSG: 'No Notifications are available',
        NO_NOTIFICATION_ROW: ['noData'],
        NOTIFICATION_LIST: ['position']
    }
};
...
export const ConfirmDialogLowerCase = {
    Yes: 'yes',
    No: 'no',
    Save: 'save',
    Cancel: 'cancel'
