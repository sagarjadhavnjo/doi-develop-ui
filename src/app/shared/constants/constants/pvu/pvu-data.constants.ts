export const DataConst = {
    EMPLOYEE_CREATION: {
        LINK: '/dashboard/pvu/employee-creation/add',
        LIST_LINK: '/dashboard/pvu/employee-creation',
        AHMEDABAD_PAO_CODE: '1100044',
        GANDHINAGAR_PAO_CODE: '1100024',
        GUJARAT_STATE_CODE: '1',
    },
    ROP: {
