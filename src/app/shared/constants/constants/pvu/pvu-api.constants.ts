export const APIConst = {
    ...
    INCREMENT: {
        LIST: {
            INCREMENT_GET_LOOKUP_DATA: 'pvu/incrementevent/list_lookup',
            INCREMENT_LIST_DATA: 'pvu/incrementevent/incrementlist/201',
            DELETE_ADDED_DATA: '',
            WORKFLOW_STATUS: 'common/workflow/getWfStatus/201',
            DELETE: 'pvu/incrementevent/501'
        },
        GET: 'pvu/incrementevent/301',
        ...
        CREATE: {
            ...
            SAVE_INCREMENT_DETAILS: 'pvu/incrementevent/101',
            VALIDATE_INCREMENT_DETAILS: 'pvu/incrementevent/validateincrementsubmit/201'
        },
        PRINT_ORDER: 'pvu/incrementevent/emp/generate-printendorsement/101',
    },
    REPORT: {
        LIST : {
